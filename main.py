...
def load_vgg(sess, vgg_path):
    ...
    return graph.get_tensor_by_name(vgg_input_tensor_name), graph.get_tensor_by_name(
        vgg_keep_prob_tensor_name), graph.get_tensor_by_name(vgg_layer3_out_tensor_name), graph.get_tensor_by_name(
        vgg_layer4_out_tensor_name), graph.get_tensor_by_name(vgg_layer7_out_tensor_name)
...
def run():
    ...
    with tf.Session() as sess:
        ...
        correct_label = tf.placeholder(tf.int32, [None, None, None, num_classes], 'correct_label')
